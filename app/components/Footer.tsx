            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="relative flex max-w-md">
                <input
                  ...
                  className="w-full glass-panel font-body rounded-full pl-6 pr-36 py-4 text-sm outline-none focus:ring-2 focus:ring-accent/25 placeholder:text-muted-foreground/50 transition-all bg-white/70"
                />
                <button
                  type="submit"
                  className="glass-button font-body absolute right-1.5 top-1.5 bottom-1.5 px-5 rounded-full text-sm font-semibold flex items-center gap-1.5"
                >
                  Subscribe
          ...
          <div className="flex flex-col md:items-end gap-5">
            ...
            <div className="flex gap-2">
              <a
                ...
                aria-label="Email"
                className="w-10 h-10 glass-panel rounded-full flex items-center justify-center text-muted-foreground hover:text-primary transition-colors"
              >
